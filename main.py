...
parser.add_argument('--dataset', choices=['c10', 'c100', 'svhn'], default='c10')
parser.add_argument('--model', choices=['mlp_mixer'], default='mlp_mixer')
...
parser.add_argument('--activation-function', default='trelu', choices=['gelu', 'trelu'])
...
parser.add_argument('--autoaugment', action='store_false')
...
if args.activation_function == 'trelu':
    experiment_name += f"_doubletrelu"
